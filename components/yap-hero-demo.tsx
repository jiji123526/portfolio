    ...
    <div className="yap-demo-column">
      <div className="yap-demo">
        <header className="yap-demo__header">
          <span
            className="yap-demo__header-action yap-demo__back"
            aria-hidden="true"
          >
          ...
          <div className="yap-demo__identity">
            <span className="yap-demo__avatar" aria-hidden="true">
              y.
            </span>
            <span>yap. demo</span>
          </div>
        ...
        <div className="yap-demo__messages">
          <div className="yap-demo__row yap-demo__row--received">
            <div className="yap-demo__bubble yap-demo__bubble--received">
              {initialReply}
            </div>
          </div>
          ...
          {sentMessage && (
            <div className="yap-demo__row yap-demo__row--sent yap-demo__row--new">
              <div className="yap-demo__bubble yap-demo__bubble--sent">
                {sentMessage}
              </div>
            </div>
          )}
          ...
          {incomingReplies.slice(0, visibleReplyCount).map((reply) => (
            <div
              className="yap-demo__row yap-demo__row--received yap-demo__row--new"
              key={reply}
            >
              <div className="yap-demo__bubble yap-demo__bubble--received">
                {reply}
          ...
          {isTyping && (
            <div className="yap-demo__row yap-demo__row--received yap-demo__row--new">
              <div
                className="yap-demo__bubble yap-demo__bubble--received yap-demo__typing"
                aria-hidden="true"
              >
                <span />
                <span />
        ...
        >
          <span className="yap-demo__plus" aria-hidden="true">
            +
          </span>
          <textarea
      ...
      <p
        className="yap-demo-instruction"
        data-visible={status === 'idle' ? 'true' : undefined}
      >
