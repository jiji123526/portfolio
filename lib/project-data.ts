...
const projectCatalog: Project[] = [
  ...
  },
  {
    ...
    duration: 'Ongoing', client: 'Independent Product', responsibilities: 'Full-corpus review and annotation, inductive taxonomy design, alias sets, hand-curated similarity thesaurus, weighted ranking, product design, APIs, database, and deployment',
    ...
    process: [
      ...
      { label: 'Ranking model', title: 'Inspectable weighted matching', body: 'Recommendations combine exact and alias matches with additive category and curated-cluster evidence rather than relying on an unexplained black box.' },
    ...
    statement: 'How might we translate subjective taste into a recommendation query users can shape and revise?',
    solutions: [
      ...
      { title: 'Scoring with context.', body: 'The engine normalizes Korean tag names and aliases into comparable token sets. Exact and alias matches short-circuit weaker checks; otherwise same-category and curated-cluster evidence contribute additively before category weighting and length normalization.', mediaNote: 'Placeholder: selected tags flowing into weighted ranked cards' },
    ...
    impact: 'Built an interpretable rule-based recommender over an 8-dimension tag taxonomy: alias normalization (NFKC + token overlap), ~15 curated similarity clusters, and layered category-weighted scoring — a legible baseline before any learned similarity',
    impactBody: 'The production flow combines onboarding, explicit include/exclude controls, alias-aware matching, category-weighted ranking, separated perfect and similar results, catalog management, and scheduled metadata refresh. Hand-curated clusters and fixed weights remain visible as a baseline rather than being presented as learned similarity.',
    takeaways: [
